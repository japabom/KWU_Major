...
lin_comb_coefficients_1 = [3.0, -1.0, 1.0]
lin_comb_coefficients_2 = [0.5, -1.5, 1.0]
lin_comb_coefficients_3 = [0.5, -5.5, 4.0]
lin_comb_coefficients_4 = [1.0, -2.0, 1.0]
...
lin_dep_R_1 = [-2.0, 1.0, 1.0]
lin_dep_R_2 = [-4.0, 1.0, -4.0/7.0]
lin_dep_R_3 = [-0.3, 0.0, 0.0, 1.0, 3.0]
...
def exchange(S, A, z):
    ...
    '''
    K = vec2rep(S,z)
    for i, c in K.f.items():
        if c == 0 or S[i] in A: continue
        return S[i]
